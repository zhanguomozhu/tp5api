<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\funs\pinyin.html";i:1509419195;s:71:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\top.html";i:1508914442;s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\left.html";i:1509328037;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>汉字转拼音</title>
...
<div class="row">
    ...
    $('#send').click(function(){
        if($('#han').val()){
             //转换
            $.post("<?php echo url('funs/sendhan'); ?>",{han:$('#han').val(),type:1},function(res){
                //console.log(res)
                if(res.code == 1001){
    ...
    $('#send1').click(function(){
        if($('#han1').val()){
             //转换
            $.post("<?php echo url('funs/sendhan'); ?>",{han:$('#han1').val(),type:2},function(res){
                //console.log(res)
                if(res.code == 1001){
