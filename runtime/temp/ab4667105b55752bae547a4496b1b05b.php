<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\funs\pdf.html";i:1509679093;s:71:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\top.html";i:1509518630;s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\left.html";i:1510277372;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>生成pdf</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">生成pdf</span>
            </div>
            <form method="post" action="<?php echo url('funs/doPdf'); ?>" target="_top">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12" align="center" style="margin-top: 20px;">
                                <input style="width: 200px;height: 100px;font-size: 30px;" type="submit" class="btn btn-success" value="点击生成pdf">
                            </div>
                        </div>
            </form>
                </div>
