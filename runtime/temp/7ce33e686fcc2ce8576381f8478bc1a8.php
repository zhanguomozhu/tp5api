<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\funs\qrcode.html";i:1509353371;s:71:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\top.html";i:1509518630;s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\left.html";i:1509328037;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>生成二维码</title>
...
<div class="row">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">输入url</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block col-sm-2 red url"></p>
                        </div> 
                        <div class="form-group">
                            <div class="col-sm-2">
                            </div>
                            <div class="col-sm-6">
                                <img src="/static/admin/images/adam-jansen.jpg" id='qrcode'>
                            </div>
                        </div> 
    ...
    $('#send').click(function(){
        if($('#url').val()){
            //检测手机号格式
            if($('#url').val().match(/^((ht|f)tps?):\/\/[\w\-]+(\.[\w\-]+)+([\w\-\.,@?^=%&:\/~\+#]*[\w\-\@?^=%&\/~\+#])?$/)){
                    $.post("<?php echo url('funs/setQrCode1'); ?>",{httpURL:$('#url').val()},function(res){
                        $('.url').html(res.msg);
