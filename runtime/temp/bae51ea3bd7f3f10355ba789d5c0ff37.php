<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\auth_group\lst.html";i:1509074625;s:71:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\top.html";i:1508914442;s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\left.html";i:1509163825;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>角色列表</title>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($groups) || $groups instanceof \think\Collection || $groups instanceof \think\Paginator): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <a href="<?php echo url('edit_status',['id'=>$vo['id'],'status'=> $vo['status']=='启用' ? 0:1]); ?>" title="点击修改状态" class="btn btn-sm <?php if($vo['status'] == '启用'): ?>btn-success<?php else: ?>btn-danger<?php endif; ?>"><?php echo $vo['status']; ?></a>
                                </td>
                               <td align="center" style="width: 20%;">
