<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\funs\sms.html";i:1509341487;s:71:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\top.html";i:1508914442;s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\left.html";i:1509328037;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>发送短信</title>
    ...
    $('#send').click(function(){
        if($('#phone').val()){
            ...
            if($('#phone').val().match(/^1[34578]\d{9}$/)){
                    $.post("<?php echo url('funs/sendY'); ?>",{phone:$('#phone').val()},function(res){
                        //console.log(res)
                        if(res.code == 1050){
