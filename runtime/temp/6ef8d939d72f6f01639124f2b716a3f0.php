<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\admin\changepw.html";i:1509076440;s:71:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\top.html";i:1508914442;s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\public\left.html";i:1509163825;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>修改密码</title>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('index'); ?>">账户管理</a>
                    </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('admin/editPW'); ?>" method="post">
                        <input type="hidden" name="id"  value="<?php echo $userinfo['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">用户名称</label>
                            <div class="col-sm-4">
                                <input class="form-control" placeholder="" name="username" required="" type="text" value="<?php echo $userinfo['username']; ?>">
                            </div>
     ...
     $("input[name='phone']").blur(function(){ 
        ...
        if(phone){
            if(phone.match(/^1[34578]\d{9}$/)){
                $.post("<?php echo url('admin/checkPhone'); ?>",{phone:phone,username:username},function(res){
                    if(res.code == 1043){
