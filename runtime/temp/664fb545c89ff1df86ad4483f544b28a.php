<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\phpStudy\WWW\tp5api\public/../application/admin\view\login\login.html";i:1509325636;}*/ ?>
<!DOCTYPE html>
        ...
        <form action="<?php echo url('login'); ?>" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    ...
                    <img src="<?php echo url('verify'); ?>" alt="验证码" style="float: left;width: 110px;height: 34;margin-left: 10px;cursor: pointer;" onclick="this.src='<?php echo url('verify'); ?>?'+Math.random();"/>
                </div>
                <div class="loginbox-submit" style="margin-top: 40px;">
                    <input class="btn btn-primary btn-block" value="登录" type="submit">
                    <p class="text-center">
                        <a  href="<?php echo url('register'); ?>">没有账号点击这里注册</a>
                    </p>
