 ...
 * @title 测试demo
 * @description 接口说明
 * @header name:key require:1 default:123 desc:秘钥(区别设置)
...
class Demo extends Base
{
     ...
     * @method GET
     *
     * @header name:device require:1 default:123 desc:设备号
     *
    ...
    public function index()
    {
       ...
       // echo json_encode(["code"=>200, "message"=>"success", "data"=>['device'=>$device]]);
        echo $this->show(1001,"success",$device);
    }
